...
"""
 THIS IS GOOD : Each class has a single, clear responsibility
"""
...
# private attributes: self.__passowrds; if we want to access that attribute :
# e = User(), then we do : print(e._User__passwords)

class UserRepository:
    """Single responsibility : Store and retrieve users"""

    def __init__(self):
        self._users: Dict[int,dict] = {} # protected
        self._next_id = 1
...
class UserService:
    """Single responsibility : Orchestrates user creation - delegates to specialized services"""
...
if __name__ == "__main__":
    ...
    # Use
    user_id = user_service.create_user("aimad@gmail.com","passowrd1234","Aimad")
    ...
    print("- Can swap eail service without touching other code")
